...
class CinemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema" do
    assert_difference("Cinema.count") do
      post cinemas_url, params: { cinema: { description: @cinema.description, image: @cinema.image, subtitle: @cinema.subtitle, title: @cinema.title } }
    end
  ...
  test "should update cinema" do
    patch cinema_url(@cinema), params: { cinema: { description: @cinema.description, image: @cinema.image, subtitle: @cinema.subtitle, title: @cinema.title } }
